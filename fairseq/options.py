...
def add_generation_args(parser):
    ...
    group.add_argument('--beam', default=5, type=int, metavar='N',
                       help='beam size')
    group.add_argument('--length', default=0, type=int, metavar='N',
                       help='length')
    group.add_argument('--ed', default=0, type=int, metavar='N',
                       help='edit distance')
    ...
    group.add_argument('--tri', default=0, type=int, metavar='T', help='pos-tagging Triangular')
    group.add_argument('--nem', default=0, type=int, metavar='N', help='pos-tagging Neural EM')
    # fmt: on
    return group
