...
from . import FairseqDecoderTri


class FairseqIncrementalDecoderTri(FairseqDecoderTri):
    ...
    *incrementally*. Thus the model must cache any long-term state that is
    ...
    def forward(self, prev_output_tokens, encoder_out, z_tokens=None, incremental_state=None):
        """
        Args:
