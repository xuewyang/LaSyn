...
class Trainer(object):
    ...
    def init_meters(self, args):
        ...
        self.meters['train_loss_c'] = AverageMeter()
        self.meters['train_nll_loss'] = AverageMeter()
        self.meters['train_nll_loss_c'] = AverageMeter()
        self.meters['valid_loss'] = AverageMeter()
        self.meters['valid_loss1'] = AverageMeter()
        self.meters['valid_loss_c'] = AverageMeter()
        self.meters['valid_nll_loss'] = AverageMeter()
        self.meters['valid_nll_loss_c'] = AverageMeter()
    ...
    def train_step(self, samples, dummy_batch=False):
        ...
        try:
            ...
            self.meters['train_loss_c'].update(logging_output.get('loss_c', 0), sample_size)
            if 'nll_loss' in logging_output:
                self.meters['train_nll_loss'].update(logging_output.get('nll_loss', 0), ntokens)
            if 'nll_loss_c' in logging_output:
                self.meters['train_nll_loss_c'].update(logging_output.get('nll_loss_c', 0), ntokens)
    ...
    def valid_step(self, sample, raise_oom=False):
        ...
        self.meters['valid_loss_c'].update(logging_output.get('loss_c', 0), sample_size)
        if 'nll_loss_c' in logging_output:
            self.meters['valid_nll_loss_c'].update(logging_output.get('nll_loss_c', 0), ntokens)
